...
fun GPhotosConfigPage(
    ...
    val label =
        "${getType(TYPE_GOOGLE_PHOTOS).typeName} $StringResources.current.source}"
    ...
    Column(
        ...
        Column(
            ...
            Icon(
                painter = painterResource("ic_google_photos.xml"),
        ...
        ElevatedButton(onClick = {
            ...
            Text(
                text = StringResources.current.link_to + " " + GOOGLE_PHOTOS.typeName,
                maxLines = 1
            )
        }
