...
fun GDriveConfigPage(
    ...
    val label =
        "${getType(TYPE_GOOGLE_DRIVE).typeName} ${StringResources.current.source}"
    ...
    Column(
        ...
        Column(
            ...
            Icon(
                painter = painterResource("ic_google_drive.xml"),
...
//        }
        ...
        ElevatedButton(onClick = {
            ...
            Text(
                text = StringResources.current.link_to + " " + GOOGLE_DRIVE.typeName,
                maxLines = 1
            )
        }
