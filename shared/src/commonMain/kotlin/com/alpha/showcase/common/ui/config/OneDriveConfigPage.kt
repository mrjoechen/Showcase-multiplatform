...
fun OneDriveConfigPage(
    ...
    val label =
        "${getType(TYPE_ONE_DRIVE).typeName} ${StringResources.current.source}"
    ...
    Column(
        ...
        Column(
            ...
            Icon(
                painter = painterResource("ic_onedrive.xml"),
        ...
        ElevatedButton(onClick = {
            ...
            Text(text = StringResources.current.link_to + " " + ONE_DRIVE.typeName, maxLines = 1)
        }
